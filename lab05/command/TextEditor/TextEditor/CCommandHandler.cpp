...
void CCommandHandler::HandleInput()
{
	m_output << "Waiting for command." << endl << "> ";
	string line;
...
void CCommandHandler::ExecuteCommand(const string & commandLine)
{
...
void CCommandHandler::SetTitle(const std::string & title)
{
	m_document.SetTitle(title);
}

void CCommandHandler::Help()
{
