...
public:
	void Fly() override
	{
		cout << "I'm flying with wings! My flight counter is " << ++m_flightCounter << " now." << endl;
	}
private:
...
class DanceWaltsBehavior : public IDanceBehavior
{
public:
	void Dance() override
	{
...
class NoDanceBehavoir : public IDanceBehavior
{
public:
	void Dance() override {}
};
...
public:
	MallardDuck()
		: Duck(make_unique<FlyWithWings>(),
			...
			make_unique<DanceWaltsBehavior>())
	{
	}
...
public:
	RedheadDuck()
		: Duck(make_unique<FlyWithWings>(),
			make_unique<QuackBehavior>(),
			make_unique<DanceMinuetBehavior>())
	{
	}
	void Display() const override
	{
...
public:
	ModelDuck()
		: Duck(make_unique<FlyNoWay>(), make_unique<QuackBehavior>(), make_unique<NoDanceBehavoir>())
	{
	}
	void Display() const override
	{
