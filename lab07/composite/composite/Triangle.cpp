...
CTriangle::CTriangle(SPoint one, SPoint two, SPoint three)
	: m_one(one)
	, m_two(two)
	, m_three(three)
{
...
RectDouble CTriangle::GetFrame()const
{
	return m_frame;
}

void CTriangle::SetFrame(const RectDouble & rect)
{
...
void CTriangle::CalculateNewVertexPosition(SPoint &vertex, RectDouble oldFrame, RectDouble newFrame)
{
